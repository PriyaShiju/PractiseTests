...
{
    public class CertificationDbContext : IdentityDbContext<PractiseTestsUser>
    {
        public DbSet<Certifications> Certifications { get; set; }
        public DbSet<TestPaper> TestPapers { get; set; }
        public DbSet<PractiseTestsUser> Users { get; set; }
        ...
        //private readonly DbContextOptions<StoreUser> _options;
        ...
        protected override async void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            await SeedAsync(modelBuilder,this);
        }

        public async Task SeedAsync(ModelBuilder modelBuilder,  CertificationDbContext context)
        {
            //StoreUser usr = await usermanager.FindByEmailAsync("itsmepriyap@gmail.com");
            //if (usr == null)
            //{
            //    usr = new StoreUser()
            //    {
            ...
            //        EmailAddress = "itsmepriyap@gmail.com",
            //        Password = "P@ssword!"
            //    };
            //    var result = await usermanager.CreateAsync(usr, usr.Password);
